...
public class MetricsSqlFilterExpressionVisitor implements ExpressionVisitor<String> {
	...
	private static final String FROM_CLAUSE = "FROM api_metrics p\n";
	...
	private static ProseoLogger logger = new ProseoLogger(MetricsSqlFilterExpressionVisitor.class);
	 ...
	 * methods).
	 *
	 * Make sure this MetricsSqlFilterExpressionVisitor was subject to an "accept" call before calling this method!
	 *
	...
	public String visitLambdaExpression(String lambdaFunction, String lambdaVariable, Expression expression)
		...
		if (null == mappedProperty) {
			...
			++paramCount;
			result = String.format(OPTION_WHERE_TEMPLATE, paramCount, attCondition.getName(), paramCount, attCondition.getOp(),
