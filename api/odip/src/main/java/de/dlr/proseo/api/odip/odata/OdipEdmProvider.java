...
/**
 * A provider for the entity data model (as defined in On-demand Interface Delivery Point Specification, ESA-EOPG-EOPGC-IF-3, issue
 * 1.2, sec. 3.1)
 *
...
public class OdipEdmProvider extends CsdlAbstractEdmProvider {
	...
	public static final FullQualifiedName EN_PRODUCTIONORDERSTATE_FQN = new FullQualifiedName(NAMESPACE,
			EN_PRODUCTIONORDERSTATE_NAME);
	...
	public static final FullQualifiedName CT_INPUTPRODUCTREFERENCE_FQN = new FullQualifiedName(NAMESPACE,
			CT_INPUTPRODUCTREFERENCE_NAME);
	...
	public static final FullQualifiedName CT_ORDER_WORKFLOWOPTION_FQN = new FullQualifiedName(NAMESPACE,
			CT_ORDER_WORKFLOWOPTION_NAME);
	...
	/**
	 * Retrieves the entity container for the ODIP entity data model.
	 *
	 * @return The entity container.
	 * @throws ODataException If an error occurs while retrieving the entity container.
	 */
	@Override
	public CsdlEntityContainer getEntityContainer() throws ODataException {
		if (logger.isTraceEnabled())
			logger.trace(">>> getEntityContainer()");
	...
	/**
	 * Retrieves the entity container info for the ODIP entity data model.
	 *
	 * @param entityContainerName The name of the entity container.
	 * @return The entity container info.
	 * @throws ODataException If an error occurs while retrieving the entity container info.
	 */
	@Override
	public CsdlEntityContainerInfo getEntityContainerInfo(FullQualifiedName entityContainerName) throws ODataException {
		if (logger.isTraceEnabled())
			logger.trace(">>> getEntityContainerInfo({})", entityContainerName);
		...
		if (logger.isTraceEnabled())
			logger.trace("<<< getEntityContainerInfo({}, {}) --> null", entityContainerName);
		return null;
	}
	 ...
	 * @throws ODataException If an error occurs while retrieving the entity set.
	 */
	@Override
	public CsdlEntitySet getEntitySet(FullQualifiedName entityContainer, String entitySetName) throws ODataException {
		...
		if (logger.isTraceEnabled())
			logger.trace("<<< getEntitySet({}, {}) --> null", entityContainer, entitySetName);
		return null;
	}
	...
	public CsdlEnumType getEnumType(FullQualifiedName enumTypeName) {
		if (logger.isTraceEnabled())
			logger.trace(">>> getEnumType({})", enumTypeName);
		...
		if (enumTypeName.equals(EN_PRODUCTIONORDERSTATE_FQN)) {
			...
			CsdlEnumMember queued = new CsdlEnumMember().setName(ENEN_PRODUCTIONORDERSTATE_QUEUED)
				.setValue(String.valueOf(ENEN_PRODUCTIONORDERSTATE_QUEUED_VAL));
			CsdlEnumMember in_progress = new CsdlEnumMember().setName(ENEN_PRODUCTIONORDERSTATE_IN_PROGRESS)
				.setValue(String.valueOf(ENEN_PRODUCTIONORDERSTATE_IN_PROGRESS_VAL));
			CsdlEnumMember completed = new CsdlEnumMember().setName(ENEN_PRODUCTIONORDERSTATE_COMPLETED)
				.setValue(String.valueOf(ENEN_PRODUCTIONORDERSTATE_COMPLETED_VAL));
			CsdlEnumMember failed = new CsdlEnumMember().setName(ENEN_PRODUCTIONORDERSTATE_FAILED)
				.setValue(String.valueOf(ENEN_PRODUCTIONORDERSTATE_FAILED_VAL));
			CsdlEnumMember cancelled = new CsdlEnumMember().setName(ENEN_PRODUCTIONORDERSTATE_CANCELLED)
				.setValue(String.valueOf(ENEN_PRODUCTIONORDERSTATE_CANCELLED_VAL));
		...
		if (logger.isTraceEnabled())
			logger.trace("<<< getEnumType({}) --> null", enumTypeName);
		return null;
	}
	...
	public CsdlComplexType getComplexType(FullQualifiedName complexTypeName) {
		if (logger.isTraceEnabled())
			logger.trace(">>> getComplexType({})", complexTypeName);
		...
		if (complexTypeName.equals(CT_CHECKSUM_FQN)) {
			...
			CsdlProperty ref = new CsdlProperty().setName(CT_INPUTPRODUCTREFERENCE_PROP_REFERENCE)
				.setType(EdmPrimitiveTypeKind.String.getFullQualifiedName());
			CsdlProperty date = new CsdlProperty().setName(CT_INPUTPRODUCTREFERENCE_PROP_CONTENTDATE).setType(CT_CONTENTDATE_FQN);
		...
		if (logger.isTraceEnabled())
			logger.trace("<<< getComplexType({}) --> null", complexTypeName);
		return null;
	}
	 ...
	 * @throws ODataException If an error occurs while retrieving the entity type.
	 */
	@Override
	public CsdlEntityType getEntityType(FullQualifiedName entityTypeName) throws ODataException {
		...
		if (entityTypeName.equals(ET_PRODUCTIONORDER_FQN) || entityTypeName.equals(ET_ORDER_FQN)) {
			...
			CsdlProperty status = new CsdlProperty().setName(ET_PRODUCTIONORDER_PROP_STATUS).setType(EN_PRODUCTIONORDERSTATE_FQN);
			...
			CsdlProperty workflowOptions = new CsdlProperty().setName(ET_PRODUCTIONORDER_PROP_WORKFLOWOPTIONS)
				.setCollection(true)
...
//					boolAttributes, dateAttributes));
			...
			CsdlProperty version = new CsdlProperty().setName(ET_WORKFLOW_PROP_WORKFLOWVERSION)
				.setType(EdmPrimitiveTypeKind.String.getFullQualifiedName());
			CsdlProperty workflowOptions = new CsdlProperty().setName(ET_WORKFLOW_PROP_WORKFLOWOPTIONS)
				.setCollection(true)
...
//					boolAttributes, dateAttributes));
			...
			CsdlProperty name = new CsdlProperty().setName(GENERIC_PROP_NAME)
				.setType(EdmPrimitiveTypeKind.String.getFullQualifiedName());
			CsdlProperty valueType = new CsdlProperty().setName(ET_ATTRIBUTE_PROP_VALUETYPE)
				.setType(EdmPrimitiveTypeKind.String.getFullQualifiedName());
		...
		if (logger.isTraceEnabled())
			logger.trace("<<< getEntityType({}) --> null", entityTypeName);
		return null;
	}

	/**
	 * Retrieves the schema for the ODIP entity data model.
	 *
	 * @return The schema.
	 * @throws ODataException If an error occurs while retrieving the schema.
	 */
	@Override
