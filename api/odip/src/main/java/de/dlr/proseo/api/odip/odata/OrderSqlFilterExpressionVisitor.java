...
public class OrderSqlFilterExpressionVisitor implements ExpressionVisitor<String> {
	...
	private static final String[][] ODATA_TO_SQL_MAPPING = { { OdipEdmProvider.GENERIC_PROP_ID, "p.uuid" },
			{ OdipEdmProvider.GENERIC_PROP_NAME, "p.name" }, { OdipEdmProvider.GENERIC_PROP_CONTENT_TYPE, null }, // not part of
																													// data model
			{ OdipEdmProvider.GENERIC_PROP_CONTENT_LENGTH, "p.file_size" }, { CscAttributeName.STATUS.getValue(), "p.order_state" },
			...
			{ CscAttributeName.WORKFLOW_ID.getValue(), "wf.uuid" }, { CscAttributeName.WORKFLOW_NAME.getValue(), "wf.name" },
