...
public class ProductEdmProvider extends CsdlAbstractEdmProvider {
	...
	public CsdlEnumType getEnumType(FullQualifiedName enumTypeName) {
		...
		if (enumTypeName.equals(EN_PRODUCTIONTYPE_FQN)) {
			...
			CsdlEnumMember systematic = new CsdlEnumMember().setName(EN_PRODUCTIONTYPE_SYSTEMATIC)
				.setValue(String.valueOf(EN_PRODUCTIONTYPE_SYSTEMATIC_VAL));
			CsdlEnumMember onDemandDefault = new CsdlEnumMember().setName(EN_PRODUCTIONTYPE_ONDEMDEF)
				.setValue(String.valueOf(EN_PRODUCTIONTYPE_ONDEMDEF_VAL));
			CsdlEnumMember onDemandNonDefault = new CsdlEnumMember().setName(EN_PRODUCTIONTYPE_ONDEMNODEF)
				.setValue(String.valueOf(EN_PRODUCTIONTYPE_ONDEMNODEF_VAL));
	...
	public CsdlEntityType getEntityType(FullQualifiedName entityTypeName) throws ODataException {
		...
		if (entityTypeName.equals(ET_PRODUCT_FQN)) {
			...
			CsdlProperty checksum = new CsdlProperty().setName(ET_PRODUCT_PROP_CHECKSUM)
				.setCollection(true)
			...
			productType.setProperties(Arrays.asList(id, name, contentType, contentLength, originDate, publicationDate, evictionDate,
					footprint, geoFootprint, checksum, contentDate, productionType));
			productType.setNavigationProperties(
					Arrays.asList(attributes, stringAttributes, intAttributes, doubleAttributes, boolAttributes, dateAttributes));
