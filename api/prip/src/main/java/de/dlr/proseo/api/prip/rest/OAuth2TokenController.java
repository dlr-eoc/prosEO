...
@RestController
@Validated
@RequestMapping(value = "/proseo/prip/v1/token", produces = "application/json")
public class OAuth2TokenController {
	 ...
	 * @param username    The PRIP username (as per RFC 6749; REQUIRED for "Resource Owner Password Credentials Grant" flow, must
	 *                    not be set otherwise)
	 * @param password    The PRIP password (as per RFC 6749; REQUIRED for "Resource Owner Password Credentials Grant" flow, must
	 *                    not be set otherwise)
