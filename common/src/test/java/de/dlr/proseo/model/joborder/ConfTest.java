...
/**
 * Test class for de.dlr.proseo.model.joborder.Conf
 *
...
public class ConfTest {
    ...
    public final void testGetProcessingParametersByName() {
        ...
        assertEquals(2, result.size(), "Unexpected result size:");
        assertEquals("v2", result.get(0).getValue(), "Unexpected first result");
        assertEquals("v4", result.get(1).getValue(), "Unexpected second result");
    }
    ...
    public final void testGetUniqueProcessingParameterByName() {
        ...
        assertEquals("v2", result.getValue(), "Unexpected result value:");
    ...
    public final void testSetProcessingParameterByName() {
        ...
        assertEquals("v5", result.getValue(), "Unexpected result value:");
