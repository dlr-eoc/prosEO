...
my $USERMGR_PWD = 'demopw';

my $CONFIG_USER = 'proseo';
my $CONFIG_PWD = 'demopw';
...
my @processors = (
    {
    	...
    	processorVersion => '2.2.0',
    	configuredProcessors => [ 'PTML1B_2.2.0_OPER_2020-03-25' ],
    	tasks => [ 
    	   { taskName => 'ptm_l01b', taskVersion => '2.2.0' }
    	],
    	dockerImage => 'localhost:5000/proseo-sample-wrapper:2.2.0'
    },
    {
        processorName => 'PTML2', 
        processorVersion => '2.2.0',
        configuredProcessors => [ 'PTML2_2.2.0_OPER_2020-03-25' ],
        tasks => [ 
           { taskName => 'ptm_l2', taskVersion => '2.2.0' }
        ],
        dockerImage => 'localhost:5000/proseo-sample-wrapper:2.2.0'
    },
    {
        processorName => 'PTML3', 
        processorVersion => '2.2.0',
        configuredProcessors => [ 'PTML3_2.2.0_OPER_2020-03-25' ],
        tasks => [ 
           { taskName => 'ptm_l3', taskVersion => '2.2.0' }
        ],
        dockerImage => 'localhost:5000/proseo-sample-wrapper:2.2.0'
    }
);
...
my @configured_processors = (
    {
    	identifier => 'PTML1B_2.2.0_OPER_2020-03-25',
    	processorName => 'PTML1B',
    	processorVersion => '2.2.0',
    	configurationVersion => 'OPER_2020-03-25' 
    },
    {
        identifier => 'PTML2_2.2.0_OPER_2020-03-25',
        processorName => 'PTML2',
        processorVersion => '2.2.0',
        configurationVersion => 'OPER_2020-03-25' 
    },
    {
        identifier => 'PTML3_2.2.0_OPER_2020-03-25',
        processorName => 'PTML3',
        processorVersion => '2.2.0',
        configurationVersion => 'OPER_2020-03-25' 
    }
...
my @workflows = (
    {
    	...
    	configuredProcessor => 'PTML3_2.2.0_OPER_2020-03-25',
...
$applicable_processors{'PTM_L1B'} = [ 'PTML1B_2.2.0_OPER_2020-03-25' ];
...
$applicable_processors{'PTM_L2_A'} = [ 'PTML2_2.2.0_OPER_2020-03-25' ];
# Output PTM_L2_B
...
$selection_rules{'PTM_L2_B'} = '
    FOR PTM_L1B_P1 SELECT LatestValCover(0, 0)';
$applicable_processors{'PTM_L2_B'} = [ 'PTML2_2.2.0_OPER_2020-03-25' ];
...
$applicable_processors{'PTM_L3'} = [ 'PTML3_2.2.0_OPER_2020-03-25' ];
