...
public class FacmgrUtil {
	 ...
	 * @return an equivalent REST processingFacility or null, if no model
	 *         ProcessingFacility was given
	 */
	public static RestProcessingFacility toRestFacility(ProcessingFacility modelFacility) {
		if (logger.isTraceEnabled())
			logger.trace(">>> toRestFacility({})", (null == modelFacility ? "MISSING" : modelFacility.getId()));
	...
	/**
	 * Convert a REST ProcessingFacility into a prosEO model ProcessingFacility
	 ...
	 * @throws IllegalArgumentException if the REST facility violates syntax rules
	 *                                  for date, enum or numeric values
	 */
	public static ProcessingFacility toModelFacility(RestProcessingFacility restFacility) {
		if (logger.isTraceEnabled())
			logger.trace(">>> toModelFacility({})", (null == restFacility ? "MISSING" : restFacility.getId()));
