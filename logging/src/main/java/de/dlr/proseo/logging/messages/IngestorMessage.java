...
public enum IngestorMessage implements ProseoMessage {
	...
	ERROR_ACQUIRE_SEMAPHORE				(2009, Level.ERROR, false,	"Error to acquire semaphore from prosEO Production Planner (cause: {0})", ""),
	...
	ERROR_RELEASE_SEMAPHORE				(2012, Level.ERROR, false,	"Error to release semaphore from prosEO Production Planner (cause: {0})", ""),
	...
	UNEXPECTED_NUMBER_OF_FILE_PATHS		(2068, Level.ERROR, false, "Unexpected number of file paths ({0}, expected: {0}) received from Storage Manager at {1}", ""),
