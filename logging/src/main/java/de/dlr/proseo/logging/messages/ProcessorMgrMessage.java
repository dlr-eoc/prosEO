...
public enum ProcessorMgrMessage implements ProseoMessage {
	...
	WORKFLOW_LIST_RETRIEVED							(4570, Level.INFO, true, "Workflow list of size {0} retrieved for mission {1}, workflow name {2}, workflow version {3}, input product class {3}, configured processor {4}, and enabled = {6}", ""),
	...
	WORKFLOWS_COUNTED								(4590, Level.INFO, true, "{0} workflow(s) found for mission {1}, workflow name {2}, workflow version {3}, input product class {4}, configured processor {5}, and enabled = {6}", ""),
