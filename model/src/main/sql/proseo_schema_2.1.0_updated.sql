...
\restrict IPV2VFQLkpc4JWuQA5wB6TUNZZRedkUDI94eQtpyqnxWAtZe7GyM46IHalI0ssN
...
CREATE TABLE public.api_metrics (
    ...
    CONSTRAINT api_metrics_metrictype_check CHECK (((metrictype >= 0) AND (metrictype <= 1)))
);
...
ALTER SEQUENCE public.api_metrics_seq OWNER TO postgres;
...
CREATE TABLE public.class_output_parameter_output_parameters (
    ...
    CONSTRAINT class_output_parameter_output_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
CREATE TABLE public.configuration (
    ...
    CONSTRAINT configuration_product_quality_check CHECK (((product_quality)::text = ANY (ARRAY[('NOMINAL'::character varying)::text, ('EXPERIMENTAL'::character varying)::text, ('TEST'::character varying)::text, ('SYSTEMATIC'::character varying)::text])))
);
...
CREATE TABLE public.configuration_dyn_proc_parameters (
    ...
    CONSTRAINT configuration_dyn_proc_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
CREATE TABLE public.input_filter_filter_conditions (
    ...
    CONSTRAINT input_filter_filter_conditions_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
CREATE TABLE public.job (
    ...
    CONSTRAINT job_job_state_check CHECK (((job_state)::text = ANY (ARRAY[('INITIAL'::character varying)::text, ('PLANNED'::character varying)::text, ('RELEASED'::character varying)::text, ('STARTED'::character varying)::text, ('ON_HOLD'::character varying)::text, ('COMPLETED'::character varying)::text, ('FAILED'::character varying)::text, ('CLOSED'::character varying)::text])))
);
...
CREATE TABLE public.job_step (
    ...
    priority integer,
    processing_completion_time timestamp(6) with time zone,
    ...
    stderr_log_level smallint,
    stdout_log_level smallint,
    job_id bigint,
    CONSTRAINT job_step_job_step_state_check CHECK (((job_step_state)::text = ANY (ARRAY[('PLANNED'::character varying)::text, ('WAITING_INPUT'::character varying)::text, ('READY'::character varying)::text, ('RUNNING'::character varying)::text, ('COMPLETED'::character varying)::text, ('FAILED'::character varying)::text, ('CLOSED'::character varying)::text]))),
    CONSTRAINT job_step_stderr_log_level_check CHECK (((stderr_log_level >= 0) AND (stderr_log_level <= 4))),
    CONSTRAINT job_step_stdout_log_level_check CHECK (((stdout_log_level >= 0) AND (stdout_log_level <= 4)))
);
...
CREATE TABLE public.job_step_output_parameters (
    ...
    parameter_value character varying(255),
    output_parameters_key character varying(255) NOT NULL,
    CONSTRAINT job_step_output_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
CREATE TABLE public.mission (
    ...
    name character varying(255),
    order_retention_period numeric(21,0),
...
CREATE TABLE public.order_template (
    ...
    production_type character varying(255),
    mission_id bigint,
    CONSTRAINT order_template_production_type_check CHECK (((production_type)::text = ANY (ARRAY[('SYSTEMATIC'::character varying)::text, ('ON_DEMAND_DEFAULT'::character varying)::text, ('ON_DEMAND_NON_DEFAULT'::character varying)::text]))),
    CONSTRAINT order_template_slicing_type_check CHECK (((slicing_type)::text = ANY (ARRAY[('ORBIT'::character varying)::text, ('CALENDAR_DAY'::character varying)::text, ('CALENDAR_MONTH'::character varying)::text, ('CALENDAR_YEAR'::character varying)::text, ('TIME_SLICE'::character varying)::text, ('NONE'::character varying)::text])))
);
...
CREATE TABLE public.order_template_dynamic_processing_parameters (
    ...
    CONSTRAINT order_template_dynamic_processing_paramete_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
CREATE TABLE public.order_template_output_parameters (
    ...
    parameter_value character varying(255),
    output_parameters_key character varying(255) NOT NULL,
    CONSTRAINT order_template_output_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
CREATE TABLE public.processing_facility (
    ...
    CONSTRAINT processing_facility_default_storage_type_check CHECK (((default_storage_type)::text = ANY (ARRAY[('S3'::character varying)::text, ('ALLUXIO'::character varying)::text, ('POSIX'::character varying)::text, ('OTHER'::character varying)::text]))),
    CONSTRAINT processing_facility_facility_state_check CHECK (((facility_state)::text = ANY (ARRAY[('DISABLED'::character varying)::text, ('STOPPED'::character varying)::text, ('STARTING'::character varying)::text, ('RUNNING'::character varying)::text, ('STOPPING'::character varying)::text])))
);
...
CREATE TABLE public.processing_order (
    ...
    input_data_timeout_period numeric(21,0),
    on_input_data_timeout_fail boolean DEFAULT true NOT NULL,
    CONSTRAINT processing_order_order_source_check CHECK (((order_source)::text = ANY (ARRAY[('CLI'::character varying)::text, ('GUI'::character varying)::text, ('ODIP'::character varying)::text, ('OTHER'::character varying)::text]))),
    CONSTRAINT processing_order_order_state_check CHECK (((order_state)::text = ANY (ARRAY[('INITIAL'::character varying)::text, ('APPROVED'::character varying)::text, ('PLANNING'::character varying)::text, ('PLANNING_FAILED'::character varying)::text, ('PLANNED'::character varying)::text, ('RELEASING'::character varying)::text, ('RELEASED'::character varying)::text, ('RUNNING'::character varying)::text, ('SUSPENDING'::character varying)::text, ('COMPLETED'::character varying)::text, ('FAILED'::character varying)::text, ('CLOSED'::character varying)::text]))),
    CONSTRAINT processing_order_production_type_check CHECK (((production_type)::text = ANY (ARRAY[('SYSTEMATIC'::character varying)::text, ('ON_DEMAND_DEFAULT'::character varying)::text, ('ON_DEMAND_NON_DEFAULT'::character varying)::text]))),
    CONSTRAINT processing_order_slicing_type_check CHECK (((slicing_type)::text = ANY (ARRAY[('ORBIT'::character varying)::text, ('CALENDAR_DAY'::character varying)::text, ('CALENDAR_MONTH'::character varying)::text, ('CALENDAR_YEAR'::character varying)::text, ('TIME_SLICE'::character varying)::text, ('NONE'::character varying)::text])))
);
...
CREATE TABLE public.processing_order_dynamic_processing_parameters (
    ...
    parameter_value character varying(255),
    dynamic_processing_parameters_key character varying(255) NOT NULL,
    CONSTRAINT processing_order_dynamic_processing_parame_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
--
-- Name: processing_order_history; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.processing_order_history (
    ...
    order_state character varying(255),
    release_time timestamp without time zone,
    CONSTRAINT processing_order_history_order_state_check CHECK (((order_state)::text = ANY (ARRAY[('INITIAL'::character varying)::text, ('APPROVED'::character varying)::text, ('PLANNING'::character varying)::text, ('PLANNING_FAILED'::character varying)::text, ('PLANNED'::character varying)::text, ('RELEASING'::character varying)::text, ('RELEASED'::character varying)::text, ('RUNNING'::character varying)::text, ('SUSPENDING'::character varying)::text, ('COMPLETED'::character varying)::text, ('FAILED'::character varying)::text, ('CLOSED'::character varying)::text])))
);
...
CREATE TABLE public.processing_order_mon_order_progress (
    processing_order_id bigint NOT NULL,
    all_job_steps integer,
    completed_job_steps integer,
    datetime timestamp without time zone,
    failed_job_steps integer,
    finished_job_steps integer,
    mon_order_state_id bigint,
    running_job_steps integer
);
...
CREATE TABLE public.processing_order_output_parameters (
    ...
    parameter_value character varying(255),
    output_parameters_key character varying(255) NOT NULL,
    CONSTRAINT processing_order_output_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
CREATE TABLE public.processor (
    ...
    processor_class_id bigint,
    CONSTRAINT processor_job_order_version_check CHECK (((job_order_version)::text = ANY (ARRAY[('MMFI_1_8'::character varying)::text, ('GMES_1_1'::character varying)::text])))
);
...
CREATE TABLE public.product (
    ...
    CONSTRAINT product_product_quality_check CHECK (((product_quality)::text = ANY (ARRAY[('NOMINAL'::character varying)::text, ('EXPERIMENTAL'::character varying)::text, ('TEST'::character varying)::text, ('SYSTEMATIC'::character varying)::text]))),
    CONSTRAINT product_production_type_check CHECK (((production_type)::text = ANY (ARRAY[('SYSTEMATIC'::character varying)::text, ('ON_DEMAND_DEFAULT'::character varying)::text, ('ON_DEMAND_NON_DEFAULT'::character varying)::text])))
);
...
CREATE TABLE public.product_archive (
    ...
    CONSTRAINT product_archive_archive_type_check CHECK (((archive_type)::text = ANY (ARRAY[('AIP'::character varying)::text, ('AUXIP'::character varying)::text, ('PODIP'::character varying)::text, ('PRIP'::character varying)::text, ('SIMPLEAIP'::character varying)::text])))
);
...
CREATE TABLE public.product_class (
    id bigint NOT NULL,
    version integer,
    default_slice_duration numeric(21,0),
    ...
    mission_id bigint,
    processor_class_id bigint,
    CONSTRAINT product_class_default_slicing_type_check CHECK (((default_slicing_type)::text = ANY (ARRAY[('ORBIT'::character varying)::text, ('CALENDAR_DAY'::character varying)::text, ('CALENDAR_MONTH'::character varying)::text, ('CALENDAR_YEAR'::character varying)::text, ('TIME_SLICE'::character varying)::text, ('NONE'::character varying)::text]))),
    CONSTRAINT product_class_processing_level_check CHECK (((processing_level)::text = ANY (ARRAY[('L0'::character varying)::text, ('L1'::character varying)::text, ('L1A'::character varying)::text, ('L1B'::character varying)::text, ('L1C'::character varying)::text, ('L2'::character varying)::text, ('L2A'::character varying)::text, ('L2B'::character varying)::text, ('L2C'::character varying)::text, ('L3'::character varying)::text, ('L4'::character varying)::text]))),
    CONSTRAINT product_class_visibility_check CHECK (((visibility)::text = ANY (ARRAY[('INTERNAL'::character varying)::text, ('RESTRICTED'::character varying)::text, ('PUBLIC'::character varying)::text])))
);
...
CREATE TABLE public.product_file (
    ...
    processing_facility_id bigint,
    product_id bigint,
    CONSTRAINT product_file_storage_type_check CHECK (((storage_type)::text = ANY (ARRAY[('S3'::character varying)::text, ('ALLUXIO'::character varying)::text, ('POSIX'::character varying)::text, ('OTHER'::character varying)::text])))
);
...
CREATE TABLE public.product_parameters (
    ...
    CONSTRAINT product_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
CREATE TABLE public.product_query (
    ...
    jpql_query_condition oid,
    minimum_coverage smallint,
    sql_query_condition oid,
...
CREATE TABLE public.product_query_filter_conditions (
    ...
    parameter_value character varying(255),
    filter_conditions_key character varying(255) NOT NULL,
    CONSTRAINT product_query_filter_conditions_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
CREATE TABLE public.simple_policy (
    ...
    CONSTRAINT simple_policy_policy_type_check CHECK (((policy_type)::text = ANY (ARRAY[('ValCover'::character varying)::text, ('LatestValCover'::character varying)::text, ('ValIntersect'::character varying)::text, ('LatestValIntersect'::character varying)::text, ('LatestValidityClosest'::character varying)::text, ('BestCenteredCover'::character varying)::text, ('LatestValCoverClosest'::character varying)::text, ('LargestOverlap'::character varying)::text, ('LargestOverlap85'::character varying)::text, ('LatestValidity'::character varying)::text, ('LatestValCoverNewestValidity'::character varying)::text, ('ClosestStartValidity'::character varying)::text, ('ClosestStopValidity'::character varying)::text, ('LatestStartValidity'::character varying)::text, ('LatestStopValidity'::character varying)::text, ('ValIntersectWithoutDuplicates'::character varying)::text, ('LastCreated'::character varying)::text])))
);
...
CREATE TABLE public.simple_policy_delta_times (
    ...
    CONSTRAINT simple_policy_delta_times_unit_check CHECK (((unit >= 0) AND (unit <= 6)))
);
...
CREATE TABLE public.simple_selection_rule_filter_conditions (
    ...
    parameter_value character varying(255),
    filter_conditions_key character varying(255) NOT NULL,
    CONSTRAINT simple_selection_rule_filter_conditions_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
CREATE TABLE public.users (
    ...
    password_expiration_date timestamp(6) without time zone NOT NULL,
    assigned bigint,
...
CREATE TABLE public.workflow (
    ...
    priority integer,
    CONSTRAINT workflow_slicing_type_check CHECK (((slicing_type)::text = ANY (ARRAY[('ORBIT'::character varying)::text, ('CALENDAR_DAY'::character varying)::text, ('CALENDAR_MONTH'::character varying)::text, ('CALENDAR_YEAR'::character varying)::text, ('TIME_SLICE'::character varying)::text, ('NONE'::character varying)::text])))
);
...
CREATE TABLE public.workflow_option (
    ...
    workflow_id bigint,
    CONSTRAINT workflow_option_type_check CHECK (((type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('NUMBER'::character varying)::text, ('DATENUMBER'::character varying)::text])))
);
...
CREATE TABLE public.workflow_output_parameters (
    ...
    parameter_value character varying(255),
    output_parameters_key character varying(255) NOT NULL,
    CONSTRAINT workflow_output_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY (ARRAY[('STRING'::character varying)::text, ('BOOLEAN'::character varying)::text, ('INTEGER'::character varying)::text, ('DOUBLE'::character varying)::text, ('INSTANT'::character varying)::text])))
);
...
--
-- Name: processing_order_history processing_order_history_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: groups_group_members uk132lanwqs6liav9syek4s96xv; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: configuration_static_input_files uk2y140wa1pggeycgihvnex0a9c; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product uk522jf0inen9r4jt9m9rhsf5bc; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: simple_selection_rule_simple_policies uk7jrn9t62kdspngixrembpkrd7; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: mon_service ukacf8th9woalj8upxo9rqqrfn3; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: processing_order_history ukbokmof3ehpoi3hsc1mdhqgvar; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: users_group_memberships uke2ijwadyxqhcr2aldhs624px; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: mon_ext_service ukojd6hfgp9ym4ennt3ardainn5; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: processing_order_history_product_types fkbwtjp244fa6xcsmac1pdisy9k; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict IPV2VFQLkpc4JWuQA5wB6TUNZZRedkUDI94eQtpyqnxWAtZe7GyM46IHalI0ssN
