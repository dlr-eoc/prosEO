...
\restrict Pw1DIL2TEY2EoDmNxFXeOkTuO1KjWm2dtxug1iOKfRF81g56QPkEX2Mg9JrJPd5
...
CREATE TABLE public.class_output_parameter_output_parameters (
    ...
    CONSTRAINT class_output_parameter_output_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY ((ARRAY['STRING'::character varying, 'BOOLEAN'::character varying, 'INTEGER'::character varying, 'DOUBLE'::character varying, 'INSTANT'::character varying])::text[])))
);
...
CREATE TABLE public.configuration (
    ...
    CONSTRAINT configuration_product_quality_check CHECK (((product_quality)::text = ANY ((ARRAY['NOMINAL'::character varying, 'EXPERIMENTAL'::character varying, 'TEST'::character varying, 'SYSTEMATIC'::character varying])::text[])))
);
...
CREATE TABLE public.configuration_dyn_proc_parameters (
    ...
    CONSTRAINT configuration_dyn_proc_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY ((ARRAY['STRING'::character varying, 'BOOLEAN'::character varying, 'INTEGER'::character varying, 'DOUBLE'::character varying, 'INSTANT'::character varying])::text[])))
);
...
CREATE TABLE public.input_filter_filter_conditions (
    ...
    CONSTRAINT input_filter_filter_conditions_parameter_type_check CHECK (((parameter_type)::text = ANY ((ARRAY['STRING'::character varying, 'BOOLEAN'::character varying, 'INTEGER'::character varying, 'DOUBLE'::character varying, 'INSTANT'::character varying])::text[])))
);
...
CREATE TABLE public.job (
    ...
    CONSTRAINT job_job_state_check CHECK (((job_state)::text = ANY ((ARRAY['INITIAL'::character varying, 'PLANNED'::character varying, 'RELEASED'::character varying, 'STARTED'::character varying, 'ON_HOLD'::character varying, 'COMPLETED'::character varying, 'FAILED'::character varying, 'CLOSED'::character varying])::text[])))
);
...
CREATE TABLE public.job_step (
    ...
    job_id bigint,
    CONSTRAINT job_step_job_step_state_check CHECK (((job_step_state)::text = ANY ((ARRAY['PLANNED'::character varying, 'WAITING_INPUT'::character varying, 'READY'::character varying, 'RUNNING'::character varying, 'COMPLETED'::character varying, 'FAILED'::character varying, 'CLOSED'::character varying])::text[]))),
...
CREATE TABLE public.job_step_output_parameters (
    ...
    parameter_value character varying(255),
    output_parameters_key character varying(255) NOT NULL,
    CONSTRAINT job_step_output_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY ((ARRAY['STRING'::character varying, 'BOOLEAN'::character varying, 'INTEGER'::character varying, 'DOUBLE'::character varying, 'INSTANT'::character varying])::text[])))
);
...
CREATE TABLE public.processing_facility (
    ...
    CONSTRAINT processing_facility_default_storage_type_check CHECK (((default_storage_type)::text = ANY ((ARRAY['S3'::character varying, 'ALLUXIO'::character varying, 'POSIX'::character varying, 'OTHER'::character varying])::text[]))),
    CONSTRAINT processing_facility_facility_state_check CHECK (((facility_state)::text = ANY ((ARRAY['DISABLED'::character varying, 'STOPPED'::character varying, 'STARTING'::character varying, 'RUNNING'::character varying, 'STOPPING'::character varying])::text[])))
);
...
CREATE TABLE public.processing_order (
    ...
    mission_id bigint,
    workflow_id bigint,
    CONSTRAINT processing_order_order_source_check CHECK (((order_source)::text = ANY ((ARRAY['CLI'::character varying, 'GUI'::character varying, 'ODIP'::character varying, 'OTHER'::character varying])::text[]))),
    CONSTRAINT processing_order_order_state_check CHECK (((order_state)::text = ANY ((ARRAY['INITIAL'::character varying, 'APPROVED'::character varying, 'PLANNING'::character varying, 'PLANNING_FAILED'::character varying, 'PLANNED'::character varying, 'RELEASING'::character varying, 'RELEASED'::character varying, 'RUNNING'::character varying, 'SUSPENDING'::character varying, 'COMPLETED'::character varying, 'FAILED'::character varying, 'CLOSED'::character varying])::text[]))),
    CONSTRAINT processing_order_production_type_check CHECK (((production_type)::text = ANY ((ARRAY['SYSTEMATIC'::character varying, 'ON_DEMAND_DEFAULT'::character varying, 'ON_DEMAND_NON_DEFAULT'::character varying])::text[]))),
    CONSTRAINT processing_order_slicing_type_check CHECK (((slicing_type)::text = ANY ((ARRAY['ORBIT'::character varying, 'CALENDAR_DAY'::character varying, 'CALENDAR_MONTH'::character varying, 'CALENDAR_YEAR'::character varying, 'TIME_SLICE'::character varying, 'NONE'::character varying])::text[])))
);
...
CREATE TABLE public.processing_order_dynamic_processing_parameters (
    ...
    parameter_value character varying(255),
    dynamic_processing_parameters_key character varying(255) NOT NULL,
    CONSTRAINT processing_order_dynamic_processing_parame_parameter_type_check CHECK (((parameter_type)::text = ANY ((ARRAY['STRING'::character varying, 'BOOLEAN'::character varying, 'INTEGER'::character varying, 'DOUBLE'::character varying, 'INSTANT'::character varying])::text[])))
);
...
CREATE TABLE public.processing_order_history (
    ...
    order_state character varying(255),
    release_time timestamp without time zone,
    CONSTRAINT processing_order_history_order_state_check CHECK (((order_state)::text = ANY ((ARRAY['INITIAL'::character varying, 'APPROVED'::character varying, 'PLANNING'::character varying, 'PLANNING_FAILED'::character varying, 'PLANNED'::character varying, 'RELEASING'::character varying, 'RELEASED'::character varying, 'RUNNING'::character varying, 'SUSPENDING'::character varying, 'COMPLETED'::character varying, 'FAILED'::character varying, 'CLOSED'::character varying])::text[])))
);
...
CREATE TABLE public.processing_order_output_parameters (
    ...
    parameter_value character varying(255),
    output_parameters_key character varying(255) NOT NULL,
    CONSTRAINT processing_order_output_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY ((ARRAY['STRING'::character varying, 'BOOLEAN'::character varying, 'INTEGER'::character varying, 'DOUBLE'::character varying, 'INSTANT'::character varying])::text[])))
);
...
CREATE TABLE public.processor (
    ...
    processor_class_id bigint,
    CONSTRAINT processor_job_order_version_check CHECK (((job_order_version)::text = ANY ((ARRAY['MMFI_1_8'::character varying, 'GMES_1_1'::character varying])::text[])))
);
...
CREATE TABLE public.product (
    ...
    CONSTRAINT product_product_quality_check CHECK (((product_quality)::text = ANY ((ARRAY['NOMINAL'::character varying, 'EXPERIMENTAL'::character varying, 'TEST'::character varying, 'SYSTEMATIC'::character varying])::text[]))),
    CONSTRAINT product_production_type_check CHECK (((production_type)::text = ANY ((ARRAY['SYSTEMATIC'::character varying, 'ON_DEMAND_DEFAULT'::character varying, 'ON_DEMAND_NON_DEFAULT'::character varying])::text[])))
);
...
CREATE TABLE public.product_archive (
    ...
    CONSTRAINT product_archive_archive_type_check CHECK (((archive_type)::text = ANY ((ARRAY['AIP'::character varying, 'AUXIP'::character varying, 'PODIP'::character varying, 'PRIP'::character varying, 'SIMPLEAIP'::character varying])::text[])))
);
...
CREATE TABLE public.product_class (
    ...
    mission_id bigint,
    processor_class_id bigint,
    CONSTRAINT product_class_default_slicing_type_check CHECK (((default_slicing_type)::text = ANY ((ARRAY['ORBIT'::character varying, 'CALENDAR_DAY'::character varying, 'CALENDAR_MONTH'::character varying, 'CALENDAR_YEAR'::character varying, 'TIME_SLICE'::character varying, 'NONE'::character varying])::text[]))),
    CONSTRAINT product_class_processing_level_check CHECK (((processing_level)::text = ANY ((ARRAY['L0'::character varying, 'L1'::character varying, 'L1A'::character varying, 'L1B'::character varying, 'L1C'::character varying, 'L2'::character varying, 'L2A'::character varying, 'L2B'::character varying, 'L2C'::character varying, 'L3'::character varying, 'L4'::character varying])::text[]))),
    CONSTRAINT product_class_visibility_check CHECK (((visibility)::text = ANY ((ARRAY['INTERNAL'::character varying, 'RESTRICTED'::character varying, 'PUBLIC'::character varying])::text[])))
);
...
CREATE TABLE public.product_file (
    ...
    processing_facility_id bigint,
    product_id bigint,
    CONSTRAINT product_file_storage_type_check CHECK (((storage_type)::text = ANY ((ARRAY['S3'::character varying, 'ALLUXIO'::character varying, 'POSIX'::character varying, 'OTHER'::character varying])::text[])))
);
...
CREATE TABLE public.product_parameters (
    ...
    CONSTRAINT product_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY ((ARRAY['STRING'::character varying, 'BOOLEAN'::character varying, 'INTEGER'::character varying, 'DOUBLE'::character varying, 'INSTANT'::character varying])::text[])))
);
...
CREATE TABLE public.product_query_filter_conditions (
    ...
    parameter_value character varying(255),
    filter_conditions_key character varying(255) NOT NULL,
    CONSTRAINT product_query_filter_conditions_parameter_type_check CHECK (((parameter_type)::text = ANY ((ARRAY['STRING'::character varying, 'BOOLEAN'::character varying, 'INTEGER'::character varying, 'DOUBLE'::character varying, 'INSTANT'::character varying])::text[])))
);
...
CREATE TABLE public.simple_policy (
    ...
    CONSTRAINT simple_policy_policy_type_check CHECK (((policy_type)::text = ANY ((ARRAY['ValCover'::character varying, 'LatestValCover'::character varying, 'ValIntersect'::character varying, 'LatestValIntersect'::character varying, 'LatestValidityClosest'::character varying, 'BestCenteredCover'::character varying, 'LatestValCoverClosest'::character varying, 'LargestOverlap'::character varying, 'LargestOverlap85'::character varying, 'LatestValidity'::character varying, 'LatestValCoverNewestValidity'::character varying, 'ClosestStartValidity'::character varying, 'ClosestStopValidity'::character varying, 'LatestStartValidity'::character varying, 'LatestStopValidity'::character varying, 'ValIntersectWithoutDuplicates'::character varying, 'LastCreated'::character varying])::text[])))
);
...
CREATE TABLE public.simple_selection_rule_filter_conditions (
    ...
    parameter_value character varying(255),
    filter_conditions_key character varying(255) NOT NULL,
    CONSTRAINT simple_selection_rule_filter_conditions_parameter_type_check CHECK (((parameter_type)::text = ANY ((ARRAY['STRING'::character varying, 'BOOLEAN'::character varying, 'INTEGER'::character varying, 'DOUBLE'::character varying, 'INSTANT'::character varying])::text[])))
);
...
CREATE TABLE public.workflow (
    ...
    CONSTRAINT workflow_slicing_type_check CHECK (((slicing_type)::text = ANY ((ARRAY['ORBIT'::character varying, 'CALENDAR_DAY'::character varying, 'CALENDAR_MONTH'::character varying, 'CALENDAR_YEAR'::character varying, 'TIME_SLICE'::character varying, 'NONE'::character varying])::text[])))
);
...
CREATE TABLE public.workflow_option (
    ...
    workflow_id bigint,
    CONSTRAINT workflow_option_type_check CHECK (((type)::text = ANY ((ARRAY['STRING'::character varying, 'NUMBER'::character varying, 'DATENUMBER'::character varying])::text[])))
);
...
CREATE TABLE public.workflow_output_parameters (
    ...
    parameter_value character varying(255),
    output_parameters_key character varying(255) NOT NULL,
    CONSTRAINT workflow_output_parameters_parameter_type_check CHECK (((parameter_type)::text = ANY ((ARRAY['STRING'::character varying, 'BOOLEAN'::character varying, 'INTEGER'::character varying, 'DOUBLE'::character varying, 'INSTANT'::character varying])::text[])))
);
...
\unrestrict Pw1DIL2TEY2EoDmNxFXeOkTuO1KjWm2dtxug1iOKfRF81g56QPkEX2Mg9JrJPd5
