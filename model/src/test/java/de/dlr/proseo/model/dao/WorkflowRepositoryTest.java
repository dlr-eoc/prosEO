...
public class WorkflowRepositoryTest {
	...
	public final void test() {
		...
		assertEquals(1, workflows.size(), "Find by mission code failed for Workflow");
		...
		assertNotNull(workflow, "Find by mission code and name failed for Workflow");
