...
public class OrdermgrSecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.authorizeHttpRequests(requests -> requests
			...
			.hasAnyRole(UserRole.ORDER_MGR.toString())
			.requestMatchers(HttpMethod.GET, base + "/ordertemplates/**")
			.hasAnyRole(UserRole.ORDER_READER.toString())
			.requestMatchers(HttpMethod.PATCH, base + "/ordertemplates/**")
			.hasAnyRole(UserRole.ORDER_MGR.toString())
			.requestMatchers(HttpMethod.POST, base + "/ordertemplates/**")
			.hasAnyRole(UserRole.ORDER_MGR.toString())
			.requestMatchers(HttpMethod.DELETE, base + "/ordertemplates/**")
			.hasAnyRole(UserRole.ORDER_MGR.toString())
			.requestMatchers(base + "/ordertemplates/**")
			.hasAnyRole(UserRole.ORDER_MGR.toString())
			.requestMatchers(base + "/ordertemplates/*")
			.hasAnyRole(UserRole.ORDER_MGR.toString())
