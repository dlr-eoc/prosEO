...
my @processors = (
    {
    	...
    	configuredProcessors => [ 'PTML1B_1.0.1_OPER_2020-03-25' ],
    	tasks => [ 
    	   { taskName => 'ptm_l01b', taskVersion => '1.0.1' }
    	],
    	dockerImage => 'localhost:5000/proseo-sample-wrapper:1.0.1'
    },
    {
        processorName => 'PTML2', 
        processorVersion => '1.0.1',
        ...
        tasks => [ 
           { taskName => 'ptm_l2', taskVersion => '1.0.1' }
        ],
        dockerImage => 'localhost:5000/proseo-sample-wrapper:1.0.1'
    },
    {
        ...
        tasks => [ 
           { taskName => 'ptm_l3', taskVersion => '1.0.1' }
        ],
        dockerImage => 'localhost:5000/proseo-sample-wrapper:1.0.1'
    }
);
...
my @configured_processors = (
    {
    	identifier => 'PTML1B_1.0.1_OPER_2020-03-25',
    	processorName => 'PTML1B',
    	processorVersion => '1.0.1',
    	configurationVersion => 'OPER_2020-03-25' 
    },
    {
        identifier => 'PTML2_1.0.1_OPER_2020-03-25',
        processorName => 'PTML2',
        processorVersion => '1.0.1',
        configurationVersion => 'OPER_2020-03-25' 
    },
    {
        identifier => 'PTML3_1.0.1_OPER_2020-03-25',
        processorName => 'PTML3',
        processorVersion => '1.0.1',
        configurationVersion => 'OPER_2020-03-25' 
    }
...
my @workflows = (
    {
    	...
    	configuredProcessor => 'PTML3_1.0.1_OPER_2020-03-25',
...
$applicable_processors{'PTM_L1B'} = [ 'PTML1B_1.0.1_OPER_2020-03-25' ];
...
$applicable_processors{'PTM_L2_A'} = [ 'PTML2_1.0.1_OPER_2020-03-25' ];
# Output PTM_L2_B
...
$applicable_processors{'PTM_L2_B'} = [ 'PTML2_1.0.1_OPER_2020-03-25' ];
...
$applicable_processors{'PTM_L3'} = [ 'PTML3_1.0.1_OPER_2020-03-25' ];
