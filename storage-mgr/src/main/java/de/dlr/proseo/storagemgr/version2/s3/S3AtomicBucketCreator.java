 ...
 */
public class S3AtomicBucketCreator implements AtomicCommand<String> {
	...
	/** Failed Info */
	private static final String FAILED = "bucket creation FAILED";
	...
	public String execute() throws IOException {
		...
		try {
			...
			throw new IOException("Bucket:" + bucket, e);
		}
	}
