/**
 * ProductControllerImplTest_upload.java
 * 
...
public class ProductControllerImplTest_upload {
	 ...
	 * 
	 */
	private void uploadRestProductFS(TestInfo testInfo) throws Exception {
		...
		for (int i = 0; i < realAbsoluteStoragePaths.size(); i++) {
			...
			assertEquals(expectedAbsoluteStoragePath, realAbsoluteStoragePath, "Real path: " + realAbsoluteStoragePath + " Expected  path: " + expectedAbsoluteStoragePath);
		}
