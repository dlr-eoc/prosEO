/**
 * ProductfileControllerImplTest_syncDownload.java
 * 
...
public class ProductfileControllerImplTest_syncDownload {
	 ...
	 */
	private void syncDownload(String testID, TestInfo testInfo) throws Exception {
